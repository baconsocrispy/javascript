...
function place(squareNumber) {
    if (!selectedSquares.some(el => el.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            selected.style.backgroundImage = "url('./img/x.png')";
        }
        else {
            selected.style.backgroundImage = "url('./img/o.png')";
        }
...
// makes board unclickable during computer turn
...
// draws line across winning cells
